...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\imgbtnmaker on
     Windows, /home/user/dev/imgbtnmaker on Linux) in a file named
     imgbtnmaker@maq and copy that file to
