...
> https://secure.php.net/downloads.php
	...
	touch ac*
	./buildconf --force
	./configure --prefix=/mnt/bin/php-5.6.9 --with-fpm-user=daemon --with-fpm-group=deploy --with-config-file-path=/mnt/bin/php-5.6.9 --with-pdo-mysql=/mnt/bin/mysql-5.6.35 --with-mysql=/mnt/bin/mysql-5.6.35 --with-mysqli=/mnt/bin/mysql-5.6.35/bin/mysql_config --with-openssl=/mnt/bin/openssl-1.0.2h --enable-soap --with-curl --with-gd --with-jpeg-dir=/usr/lib --with-freetype-dir=/usr/lib --enable-shmop --enable-sockets --enable-mbstring --with-pic --enable-fpm --with-mcrypt --enable-xcache --with-ssh2 --enable-redis --with-gnupg --enable-zip --with-zlib --with-libzip --with-svn
	make clean
	make
	make install
