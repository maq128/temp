...
#### php
	...
	touch ac*
	./buildconf --force
	./configure --prefix=/mnt/bin/php-5.6.5 --enable-xcache --enable-soap --with-pdo-mysql=/mnt/bin/mysql-5.5.48 --with-mysql=/mnt/bin/mysql-5.5.48 --with-openssl --with-zlib --with-curl --with-gd --with-jpeg-dir=/usr/lib --with-freetype-dir=/usr/lib --with-config-file-path=/mnt/bin/php-5.6.5 --enable-shmop --with-ssh2 --enable-sockets --enable-mbstring --enable-redis --enable-zip --with-pic --with-gnupg --enable-fpm --with-fpm-user=daemon --with-fpm-group=deploy
	make clean
	make
	make install
